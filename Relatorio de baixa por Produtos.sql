...
FROM
	...
	SELECT 
		...
		TRUNC((TO_DATE(E1.E1_VENCTO, 'YYYYMMDD') - TO_DATE('19700101', 'YYYYMMDD')) / 7) AS WVENCTO, 
		CASE
		...
		END AS QEMISSAO, 
		CASE
			WHEN SUBSTR(E1.E1_VENCTO, 7, 2) <= 15
			THEN SUBSTR(E1.E1_VENCTO, 1, 6) || '.1'
			ELSE SUBSTR(E1.E1_VENCTO, 1, 6) || '.2'
		END AS QVENCTO, 
		SUBSTR(E1.E1_EMISSAO, 1, 6) AS MEMISSAO, 
		SUBSTR(E1.E1_VENCTO, 1, 6) AS MVENCTO, 
		CASE
		...
		END AS SEMISSAO, 
		CASE
			WHEN SUBSTR(E1.E1_VENCTO, 5, 2) <= 6
			THEN SUBSTR(E1.E1_VENCTO, 1, 4) || '.1'
			ELSE SUBSTR(E1.E1_VENCTO, 1, 4) || '.2'
		END AS SVENCTO, 
		SUBSTR(E1.E1_EMISSAO, 1, 4) AS AEMISSAO, 
		SUBSTR(E1.E1_VENCTO, 1, 4) AS AVENCTO, 
		E1.E1_SALDO AS SALDO, 
		E1.E1_NUMBCO AS NUMBCO, 
		E1.E1_BAIXA AS ULTIMA_BAIXA, 
		A3.A3_COD AS VEND_COD, 
